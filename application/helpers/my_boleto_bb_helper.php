...
if (!defined('BASEPATH')) exit('No direct script access allowed');
	if (!function_exists('boleto_bb')) {
		...
		function boleto_bb($dados_cliente=null, $dados_empresa=null, $dados_boleto=null, $valores_boleto=null)
		{
			...
			$taxa_boleto = 2.95;
			$data_venc = '19/04/2018';  // Prazo de X dias OU informe data: "13/04/2006"; 
			$valor_cobrado = "2950,00"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
			$valor_cobrado = str_replace(",", ".",$valor_cobrado);
			$valor_boleto=number_format(80, 2, ',', '');

			$dadosboleto["nosso_numero"] = "00001502006";
			$dadosboleto["numero_documento"] = "001502006";	// Num do pedido ou do documento
			...
			$dadosboleto["agencia"] = "1482"; // Num da agencia, sem digito
			$dadosboleto["conta"] = "22221"; 	// Num da conta, sem digito

			// DADOS PERSONALIZADOS - BANCO DO BRASIL
			$dadosboleto["convenio"] = "19879194";  // Num do conv�nio - REGRA: 6 ou 7 ou 8 d�gitos
			$dadosboleto["contrato"] = ""; // Num do seu contrato
			$dadosboleto["carteira"] = "11";
