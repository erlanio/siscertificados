                    ...
                    <?php if ($num_sub > 0) { ?>
                        <table class="table table-bordered table-action thead col-md-8">
                            ...
                            foreach ($sub_trabalho as $submissoes) {
                                ...
                                echo "<td><button type='button' disabled class='btn btn-primary btn-group-xs' data-toggle='modal'><i class='glyphicon glyphicon-time'></i> " . $submissoes->descricao."</button></td>";
								if($submissoes->id_status_avaliacao == 3){ ?>
									<td><button class="btn btn-primary" data-toggle="modal" data-target="#myModalEdit-<?php echo $id_submissao; ?>"><i class='glyphicon glyphicon-edit'></i> Editar trabalho</button></div></td>
								<?php }else{ ?>
									<td><button class="btn btn-warning" ><i class='glyphicon glyphicon-edit'></i> Editar trabalho</button></div></td>
								<?php }
                                echo "</tbody>";
                            }
                            ?>
                                    ...
                                    <div class="panel panel-primary">
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control hidden"  id="orientador" name="orientador" placeholder="Informe o Orientador">


                                            <?php for ($i = 1; $i <= $num_coAutores; $i++) { ?>
                                                <div class="form-group">
                                                    <label for="titulo" id="titulo-t">Coautor <?php echo $i; ?>:</label><span class="aviso-erro"> </span>
                                                    <input type="text" class="form-control" id="coautor<?php echo $i; ?>" name="coautor<?php echo $i; ?>" >
                                                </div>
                                            <?php } ?>                        
                                        </div>
                                    </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <?php for ($i = 1; $i <= $num_coAutores; $i++) { ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="coautor<?php echo $i + 1; ?>" name="coautor<?php echo $i + 1; ?>" value="<?php if(!empty($coautor[$i + 1])){echo $coautor[$i + 1];} ?>" >
                                                    </div>
