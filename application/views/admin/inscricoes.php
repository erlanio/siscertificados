        ...
        <div class="container-fluid">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer icones-modal">      
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#palestras<?php echo $id_evento; ?>"><i class="glyphicon glyphicon-search"></i> Palestras</button>
            ...
            ******************************* MODAL OFICINAS ***************************************
            ...
            foreach ($eventosAtivos as $data) {
                ...
                <div id="palestras<?php echo $id_evento; ?>" class="modal modal-wide fade">
                    <div class="modal-dialog modal-lg">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Paletras: <?php echo $nome_evento; ?></h4>
                            </div>
                            <div class="modal-body">
                                <div class="hidden" id="aguarde-oficina<?php echo $id_evento; ?>">
                                    <img src="<?php echo base_url('assets/img/aguarde.gif'); ?>" class="img-responsive">
