        ...
        <div class="container-fluid corpo-inicio">
            ...
            <div class="col-md-12 bloco-inputs">
                <div class="card card-container">
                    ...
                    <form class="form-signin" method="post" action="<?php echo base_url('Login/recuperarSenha'); ?>">
                        <input type="email" id="inputEmail" class="form-control" placeholder="Email" name="email" required autofocus>

                        <button class="btn btn-lg btn-primary btn-block btn-signin enviar" type="submit">Recuperar Senha</button>
                    </form><!-- /form -->
